...
$con = mysqli_connect('localhost', 'educayso_facae', 'kSxMP1!DWkl{') or die("document.write('Error');");

mysqli_select_db($con,"educayso_facae") or die ("no database");
...
$sql = "SELECT visitas FROM visita WHERE enlace='$enlace'";
...
if (isset($_COOKIE[md5($enlace)])) {
    ...
    if ($rows > 0) {
        ...
        $SQL = "UPDATE visita SET visitas=visitas+1 WHERE enlace='$enlace'";
        ...
        $SQL = "INSERT INTO visita (enlace,visitas) VALUES ('$enlace',1)";
