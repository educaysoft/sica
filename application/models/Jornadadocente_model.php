...
class Jornadadocente_model extends CI_model {
	...
	function lista_jornadadocentesA(){
 	...
 	function jornadadocentexdist3( $iddistributivo){
 		$jornadadocente = $this->db->query('select * from jornadadocente1 where iddistributivo="'. $iddistributivo.'" order by numeronivel,paralelo,iddiasemana,horainicio');
 		return $jornadadocente;
 	}
