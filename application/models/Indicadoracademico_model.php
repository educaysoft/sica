...
// Para ir al último registro
	...
	function indicador1($idperiodoacademico)
	{
 		...
 		$indicadoracademico = $this->db->query('select dido.eldocente, (select estu.idnivelestudio from estudio estu where estu.idnivelestudio=4 and estu.idpersona=doce.idpersona) as nivel  ,(select estu.titulo from estudio estu where estu.idnivelestudio=4 and estu.idpersona=doce.idpersona) as titulo  from docente0 doce,distributivodocente1 dido where doce.iddocente=dido.iddocente and dido.idperiodoacademico='.$idperiodoacademico);
