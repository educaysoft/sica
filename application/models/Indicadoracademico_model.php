...
// Para ir al último registro
	...
	function indicador1($idperiodoacademico)
	{
 		...
 		$indicadoracademico = $this->db->query('select dido.eldocente, (select estu.idnivelestudio from estudio estu where estu.idnivel=4) as nivel  ,(select estu.titulo from estudio estu where estu.idnivel=4) as titulo  from docente1 doce,distributivodocente1 dido where doce.iddocente=dido.iddocente and dido.idperiodoacademico=$idperiodoacaeemico');
