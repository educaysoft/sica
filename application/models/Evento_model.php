...
class Evento_model extends CI_model {
	...
	$evento = $this->db->query('select * from evento1 where EXISTS (select idevento from  where participante.idevento=evento1.idevento and participante.idpersona= "'.$idpersona.'") order by idevento');
	...
	$evento = $this->db->query('select * from evento1 where idevento_estado in (2,3) and  EXISTS (select idevento from  where participante.idevento=evento1.idevento and participante.idpersona= "'.$idpersona.'") order by idevento');
