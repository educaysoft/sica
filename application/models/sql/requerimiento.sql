...
create table gestion(idgestion int(11) not null auto_increment primary key, detalle varchar(100),fechagestion datetime, idrequerimiento int(11) , iddepartamento int, FOREIGN KEY (idrequerimiento) REFERENCES requerimiento(idrequerimiento),FOREIGN KEY (iddepartamento) REFERENCES departamento(iddepartamento),   fechacreacion datetime,fechaactualizacion datetime );
