...
select tema.idtema,tema.nombrecorto, tema.numerosesion,unidadsilabo.idunidadsilabo,unidadsilabo.nombre as launidadsilabo,unidadsilabo.unidad,silabo.idsilabo, silabo.nombre as elsilabo,tema.duracionminutos,tema.idvideotutorial,0 as idevaluacion  from tema, unidadsilabo, silabo,videotutorial where tema.idunidadsilabo=unidadsilabo.idunidadsilabo and unidadsilabo.idsilabo=silabo.idsilabo and tema.idvideotutorial=0;
