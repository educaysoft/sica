...
create view asistencia1 as select asistencia.idasistencia,asistencia.idevento,evento.titulo as elevento,asistencia.idpersona,concat(persona.apellidos," ",persona.nombres) as lapersona,asistencia.fecha,tipoasistencia.idtipoasistencia, tipoasistencia.nombre as tipoasistencia,asistencia.comentario from asistencia,persona,evento,tipoasistencia where asistencia.idpersona=persona.idpersona and asistencia.idevento=evento.idevento and asistencia.idtipoasistencia=tipoasistencia.idtipoasistencia;
