...
create table jornadadocente(idjornadadocente int(11) not null auto_increment primary key,asignaturadocente int(11), fecha date,horainicio time,duracionminutos int);
