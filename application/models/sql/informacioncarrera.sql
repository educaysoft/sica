...
CREATE TABLE `informacioncarrera` (
  `idinformacioncarrera` int NOT NULL,
...
--
ALTER TABLE `informacioncarrera`
  ADD PRIMARY KEY (`idinformacioncarrera`),
...
--
ALTER TABLE `informacioncarrera`
  MODIFY `idinformacioncarrera` int NOT NULL AUTO_INCREMENT;
