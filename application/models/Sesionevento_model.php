...
class Sesionevento_model extends CI_model {
	...
	function listar_sesionevento1(){
 	...
 	function sesioneventosA( $id){
 		$sesionevento = $this->db->query('select * from sesionevento1 where idevento="'. $id.'" ORDER BY DATE_FORMAT(fecha ASC,"%M %d, %Y")');
 		return $sesionevento;
 	}
