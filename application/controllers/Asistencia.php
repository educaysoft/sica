...
class Asistencia extends CI_Controller{
	...
	$data['distributivodocente']=$this->distributivodocente_model->distributivodocentes1($data['jornadadocente'][0]->iddistributivodocente)->result();
	echo $data['jornadadocente'][0]->iddistributivodocente;
