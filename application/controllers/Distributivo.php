...
// Preparar los datos para exportar a Excel
    ...
    foreach ($asignaturadocentes as $docente) {
        ...
        if($cedula != $docente->cedula){
            ...
            $data[] = ["","","","","","", $docente->area,$docente->laasignatura,$docente->afinidad,$docente->numeronivelacademico,$docente->paralelo,$horassemanales,$docente->horasclases,$docente->horasmetodologicas-$docente->horasclases,$docente->horasinvestigacion,$docente->horasvinculacion,$docente->horasgestion,$totalhoras];
        }
    }
