...
//	$resultado = $mysqli->query($query);
	...
	$pdf->titulo="FUENTES DE INFORMACIÓN CALIDAD DE CARRERA ";  //$informacioncarreras[0]->eltipodocu;
	...
	$h=5;
	$i=0;
	foreach ($informacioncarreras as $row){  //Recorre todas la participaciones realiadas por los participantes
		$l=strlen($row->nombre);
	//	echo $l;
	//	die();
		   if($l>78){
		    ...
		    $pdf->Cell(10,$h,utf8_decode($row->idinformacioncarrera),1,0,'L',0);
		 $current_x = $pdf->GetX();
		 $current_y = $pdf->GetY();
