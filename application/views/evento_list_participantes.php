...
$('#show_data').on('click','.item_enviar',function(){
	...
	if(archivo != ''){
		...
		var certi= ubicacion.trim()+archivo.trim();
		 ...
		 var asunto='UTLVTE - VINCULACION MANTENIMIENTO DE LABORATORIO DE COMPUTACIÓN'; //'ARMADA DEL ECUADOR - UTLVTE : CERTIFICACIÓN DIGITAL';
		...
		var foot0="<div style='text-align:center; background-color:lightgrey; padding:10px;'> Aprovechamos la oportunidad para informarte que la Universidad Técnica Luis Vargas Torres esta ofertando los siguientes programas de postgrado.<br><br> <img src='http://educaysoft.org/maestria/maestriasutlvte.jpg' width='100%' height='100%'></div>" ;
