...
$('#show_data').on('click','.item_enviar',function(){
	...
	if(archivo != ''){
		...
		var foot0="<div style='text-align:center; background-color:lightgrey;'> Aprovechamos la oportunidad para informarte que la Universidad Técnica Luis Vargas Torres esta ofertando los siguientes programas de postgrado.<br> <img src='http://educaysoft.org/maestria/maestriasutlvte.jpg' width='70%' height='70%'></div>" ;
