...
foreach($formatoinstitucionals as $row){
	...
	$data=$data.'
		...
		<img src="https://repositorioutlvte.org/Repositorio/qr/formatoinstitucional-'.$row->idinstitucion.'-'.$row->idinstitucion.'.png" height="150px">
		</div>
      		<div >
...
// Remote file url
$remoteFile = "https://repositorioutlvte.org/Repositorio/formatoinstitucionals/formatoinstitucional".trim($row->idformatoinstitucional).".jpg";

$file_headers = @get_headers($remoteFile);

if($file_headers[0] == 'HTTP/1.1 404 Not Found') {

    $data=$data.'<image href="https://repositorioutlvte.org/Repositorio/formatoinstitucionals/formatoinstitucional0.jpg" alt="No hay programación" height="100%" width="100%"/> </svg>
...
$data=$data.'<image  class="thumbnail" href="https://repositorioutlvte.org/Repositorio/formatoinstitucionals/formatoinstitucional'.trim($row->idformatoinstitucional).'.jpg" alt="No hay programación" height="100%" width="100%"  onclick="mostrarImagen(\'https://repositorioutlvte.org/Repositorio/formatoinstitucionals/formatoinstitucional'.trim($row->idformatoinstitucional).'.jpg\')" /> </svg>
...
<div class="row justify-content-center">
 ...
 <div class="row">
  <div class="col-12">
             <div class="col-md-12">
                 <h3>Lista de formatoinstitucionals 
