...
<div style=" flex-basis: 40%"  >
      ...
      <div >
        ...
        <p class="lead text-muted">Evento:'.$row->elevento.'.</p>
...
// Remote file url
$remoteFile = "https://repositorioutlvte.org/Repositorio/foto/".trim($row->cedula).".jpg";
...
$data=$data.'</div>
            ...
            <div class="card-body">
              ...
              <p class="card-text"><b>Paralelo : </b> '.$row->grupoletra.'".</p>
