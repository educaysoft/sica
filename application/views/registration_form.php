...
<div class="w3-container" id="eys-registro">
		...
		<div style="width: 50%;  padding:5px;   display: inline-flex; " >
			<div   style="width:100%; height:700px; ">
				...
				<div ><center> <img src="<?php echo base_url(); ?>images/CentroEducacionContinua.png" style="height: 80px;" alt="Centro de Educación Continua UTLVTE"></img></center>   </div>
...
if(sizeof($eventos)>1){
	...
	$textarea_options = array('class' => 'form-control','rows' => '3',   'cols' => '8',"disabled"=>"disabled",  'class'=>'col-md-12', style="height:100px !important;");    
