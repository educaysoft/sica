...
echo form_input('nombre',"",array("disabled"=>"disabled","style"=>"width:500px")) ;
}else{
echo form_input('nombre',$options[$participante['iddocumento']],array("disabled"=>"disabled","style"=>"width:500px"));
}
		?>
	</div> 
</div> 
