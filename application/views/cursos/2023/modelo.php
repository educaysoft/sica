...
<img src='https://repositorioutlvte.org/Repositorio/fotos/0801215328.jpg' width='100%' height='100%' style='border-radius:50px;'>
	      ...
	      <p><b>Hora:</b>  10:00 - 12:00 </p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href='https://educaysoft.org/sica/login/validarcorreo?idevento=353'"  >Inscribete</button>
...
<img src='https://repositorioutlvte.org/Repositorio/fotos/1714184429.jpg' width='100%' height='100%' style='border-radius:50px;'>
	      ...
	      <p><b>Instructor:</b> Ing.Solano Gutierrez Alfredo MsC.</p>
...
<div class='img-contenedor w3-card-4' style='position:absolute; top:0px;right:0px; border: 2px solid green; border-radius: 50%; width: 30%; display:flex; justify-content: center; align-items: center;'>
<img src='https://repositorioutlvte.org/Repositorio/fotos/0803487453.jpg' width='100%' height='100%' style='border-radius:50px;'>
</div>

            <div class="card-body">
              <p class="card-text">Portafolio Digital - Paralelo A".</p>
	      <p><b>Instructor:</b> Ing.Macias Lara Alejandro MsC.</p>
...
<img src='https://repositorioutlvte.org/Repositorio/fotos/0803487453.jpg' width='100%' height='100%' style='border-radius:50px;'>
            ...
            <div class="card-body">
              <p class="card-text">Portafolio Digital - Paralelo B".</p>
	      <p><b>Instructor:</b> Ing.Macias Lara Alejandro MsC.</p>
