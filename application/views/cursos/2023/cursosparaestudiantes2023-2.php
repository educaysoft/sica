  ...
  <div class="album py-5 bg-light">
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
		...
		<a  href='https://educaysoft.org/sica/evento/detalle/358'><svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><image href="<?php echo base_url(); ?>images/cursos/358.jpg" height="100%" width="100%"/>  </svg></a>
...
<img src='https://repositorioutlvte.org/Repositorio/fotos/0803195957.jpg' width='100%' height='100%' style='border-radius:50px;'>
</div>
	      ...
	      <p><b>Hora:</b>  10:00 - 12:00 </p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href='https://educaysoft.org/sica/login/validarcorreo?idevento=358'"  >Inscribete</button>
