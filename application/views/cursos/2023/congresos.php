  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Congresos Internacionales</h1>
        <p class="lead text-muted">Inscribete y da seguimiento a la organización y a la ejecución del congreso  .</p>
      <!---  <p>
...
<img src='https://repositorioutlvte.org/Repositorio/fotos/0802157867.png' width='100%' height='100%' style='border-radius:50px;'>
	      ...
	      <p><b>Hora:</b>  14:00 - 16:00 </p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href='https://educaysoft.org/sica/index.php/login/user_registration_show?idevento=337'"  >Inscribete</button>
...
<img src='https://repositorioutlvte.org/Repositorio/fotos/0800797797.png' width='100%' height='100%' style='border-radius:50px;'>
	      ...
	      <p><b>Hora:</b>  08:00 - 16:00 </p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href='https://educaysoft.org/sica/index.php/login/user_registration_show?idevento=338'"  >Inscribete</button>
                  <button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href='https://educaysoft.org/sica/login'">Ingresa</button>
                </div>
                <small class="text-muted"><b>Modalidad:</b>On-line</small>
              </div>
...
<footer class="text-muted py-5">
  <div class="container">
    ...
    <p class="mb-1">Eventos de Educación Continua UTLVTE fue creado por &copy; EDUCAYSOFT, como parte de un proyecto de desarrollo de software universitario</p>
