...
$('#validarcorreo').click(function() {
	...
	function enviar_correo(){
		 ...
		 var nome= 'Stalin Francis Q.'; // document.getElementById("lapersona_edit").value; 		
                 var msg="Ingrea al siguiente link para terminar su registro <br><br><a href='https://educaysoft.org/sica/index.php/login/user_registration_show'>Registrate aqui</a>";  //tinyMCE.activeEditor.getContent({format:'text'});
