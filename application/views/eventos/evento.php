...
<a href= "<?php echo base_url(); ?>curso/evaluar?idpersona=<?echo $this->session->userdata['logged_in']['idpersona']; ?>$idsilabo=<?php echo $evento['idsilabo']; ?>&idtema=<?php echo $row->idtema; ?> "   ><i class='fa fa-check'></i></a>
		<?php }else{ ?>
