...
<td><?php echo form_input('fechainicia',  (isset($evento['fechainicia']) ? date('Y-m-d H:i:s', strtotime($evento['fechainicia'])) : ""), 'class="form-control  datetime" id="start_date" autocomplete="off"',array("type"=>"date")); ?></td>
  </tr>
...
<td><?php echo form_input('fechafinaliza',  (isset($evento['fechafinaliza']) ? date('Y-m-d H:i:s', strtotime($evento['fechafinaliza'])) : ""), 'class="form-control  datetime" id="start_date" autocomplete="off"',array("type"=>"date")); ?></td>
  </tr>
