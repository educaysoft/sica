...
';
			...
			$file='application/views/cursos/portafolio-'.$row->elperiodoacademico.'-'.$row->iddepartamento.'.php';
...
<div class="row justify-content-center">
 ...
 <div class="row">
  <div class="col-12">
	...
	<div id="eys-nav-i">
	<ul>
    		<li> <?php echo anchor('matricula', 'Home'); ?></li>
	</ul>
       	</div>
<br>
...
$(document).ready(function(){
	var mytabla= $('#mydatac').DataTable({"ajax": {url: '<?php echo site_url('matricula/matricula_data')?>', type: 'GET'},});
