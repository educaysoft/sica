...
$(document).ready(function(){
	...
	var idpersona=<?php echo  $this->uri->segment(3);  ?>;
	var mytabla= $('#mydatac').DataTable({"ajax": {url: '<?php echo site_url('persona/relacion_data')?>', type: 'GET',data:{idpersona:idpersona}},});
